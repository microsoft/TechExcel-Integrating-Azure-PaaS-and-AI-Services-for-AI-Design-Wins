...
- Repeat the steps above to execute the `DeployApimAndRedisResources.bicep` script in the `src/InfrastructureAsCode/` folder.
  ...
  - Once the deployment completes, you should see the resources created by the script. These include: an API Management service and a Redis Enterprise cluster.
