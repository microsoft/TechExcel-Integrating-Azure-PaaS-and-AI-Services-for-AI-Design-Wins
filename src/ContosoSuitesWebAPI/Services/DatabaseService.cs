...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get bookings for a specific hotel starting from a minimum date.")]
    ...
    [KernelFunction]
    [Description("Get bookings missing associated hotel rooms.")]
    ...
    [KernelFunction]
    [Description("Get bookings with multiple associated hotel rooms.")]
