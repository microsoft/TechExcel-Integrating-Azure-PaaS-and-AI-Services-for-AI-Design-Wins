...
public class DatabaseService : IDatabaseService
{
    ...
    ///     /// Narendra
    [KernelFunction]
    [Description("Get hotels bookings")]
    /// Narendra
    ...
    /// Narendra
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel and date time")] int hotelId, DateTime dt)
    {
